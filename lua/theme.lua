...
function M.setup()
	...
	--  Clear the background of the highlight groups
	local transparent_groups = {
		"Normal", -- Standard text and background
		"NormalNC", -- Non-current windows
		"NormalFloat", -- Floating windows (like hover docs or lazy.nvim)
		"LineNr", -- Line numbers
		"SignColumn", -- The column where git signs/errors appear
		"EndOfBuffer", -- The empty tildes (~) at the end of a file
		"FoldColumn", -- The column used for code folding
	}
